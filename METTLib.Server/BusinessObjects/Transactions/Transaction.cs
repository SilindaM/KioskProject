// Generated 20 Feb 2023 15:44 - Singular Systems Object Generator Version 2.2.694
//<auto-generated/>
using System;
using Csla;
...
namespace MELib.Transactions
{
    ...
    public class Transaction
     : SingularBusinessBase<Transaction>
    {
        ...
        public static PropertyInfo<int> TransactionTypeIDProperty = RegisterProperty<int>(c => c.TransactionTypeID, "Transaction Type", 0);
        /// <summary>
        ...
        public static PropertyInfo<Decimal> CurrentBalanceProperty = RegisterProperty<Decimal>(c => c.CurrentBalance, "Current Balance", 0D);
        /// <summary>
        /// Gets and sets the Current Balance value
        /// </summary>
        [Display(Name = "Current Balance", Description = "")]
        public Decimal CurrentBalance
        {
            get { return GetProperty(CurrentBalanceProperty); }
            set { SetProperty(CurrentBalanceProperty, value); }
        }

        public static PropertyInfo<Decimal> NewBalanceProperty = RegisterProperty<Decimal>(c => c.NewBalance, "New Balance", 0D);
        /// <summary>
        /// Gets and sets the New Balance value
        /// </summary>
        [Display(Name = "New Balance", Description = "")]
        public Decimal NewBalance
        {
            get { return GetProperty(NewBalanceProperty); }
            set { SetProperty(NewBalanceProperty, value); }
        }
        ...
        protected void Fetch(SafeDataReader sdr)
        {
            using (BypassPropertyChecks)
            {
                ...
                LoadProperty(CurrentBalanceProperty, sdr.GetDecimal(i++));
                LoadProperty(NewBalanceProperty, sdr.GetDecimal(i++));
            }
        ...
        protected override Action<SqlCommand> SetupSaveCommand(SqlCommand cm)
        {
            ...
            cm.Parameters.AddWithValue("@CurrentBalance", GetProperty(CurrentBalanceProperty));
            cm.Parameters.AddWithValue("@NewBalance", GetProperty(NewBalanceProperty));
