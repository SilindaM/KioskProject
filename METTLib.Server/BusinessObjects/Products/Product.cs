...
namespace MELib.Products
{
     ...
     : MEBusinessBase<Product>
    {
        ...
        /// </summary>
        [Display(Name = "Product Description", Description = "Short Description of the Product")]
        ...
        /// </summary>
        [Display(Name = "Price", Description = "Price of the product"),
        ...
        public static PropertyInfo<int> ProductQuantityProperty = RegisterProperty<int>(c => c.ProductQuantity, "ProductQuantity", 0);
        /// <summary>
        /// Gets and sets the ProductQuantity value
        /// </summary>
        [Display(Name = "ProductQuantity", Description = "Number of Products available"),
