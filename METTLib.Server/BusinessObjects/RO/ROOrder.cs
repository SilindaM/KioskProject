...
namespace MELib.RO
{
     ...
     : SingularBusinessBase<Order>
    {
        ...
        public static PropertyInfo<int> OrderTypeIdProperty = RegisterProperty<int>(c => c.OrderTypeId, "Order Type", 0);
        /// <summary>
        ...
        public static PropertyInfo<OrderDetailList> OrderDetailListProperty = RegisterProperty<OrderDetailList>(c => c.OrderDetailList, "Order Detail List");

        public OrderDetailList OrderDetailList
        {
            get
            {
                if (GetProperty(OrderDetailListProperty) == null)
                {
                    LoadProperty(OrderDetailListProperty, RO.OrderDetailList.NewOrderDetailList());
                }
                return GetProperty(OrderDetailListProperty);
            }
        }
        ...
        protected override String[] TableReferencesToIgnore
        {
            get
            {
                return new String[] { "OrderDetails" };
            }
        }
    ...
    if (this.IsNew)
        ...
        {
            UpdateChild(GetProperty(OrderDetailListProperty));
        }
