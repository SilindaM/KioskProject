// Generated 08 Mar 2023 13:53 - Singular Systems Object Generator Version 2.2.694
//<auto-generated/>
using System;
using Csla;
...
namespace MELib.RO
{
     ...
     : SingularBusinessBase<TransactionType>
    {
        ...
        public static PropertyInfo<String> TransactionNameProperty = RegisterProperty<String>(c => c.TransactionName, "Transaction Name", "");
        /// <summary>
        /// Gets and sets the Transaction Name value
        /// </summary>
        [Display(Name = "Transaction Name", Description = ""),
        StringLength(250, ErrorMessage = "Transaction Name cannot be more than 250 characters")]
        public String TransactionName
        {
            get { return GetProperty(TransactionNameProperty); }
            set { SetProperty(TransactionNameProperty, value); }
        }
        ...
        {
            if (this.TransactionName.Length == 0)
            {
                if (this.IsNew)
                {
        ...
        protected void Fetch(SafeDataReader sdr)
        {
            using (BypassPropertyChecks)
            {
                ...
                LoadProperty(TransactionNameProperty, sdr.GetString(i++));
        ...
        protected override Action<SqlCommand> SetupSaveCommand(SqlCommand cm)
        {
            ...
            cm.Parameters.AddWithValue("@TransactionName", GetProperty(TransactionNameProperty));
