   ...
   : MEBusinessBase<Account>
  {
    ...
    public int UserID
    {
      ...
      set { SetProperty(UserIDProperty, value); }
        ...
        /// Gets and sets the Balance value
        /// </summary>
        public void TrySave(Account currentUser)
        {
    ...
    public static PropertyInfo<string> AccountTypeProperty = RegisterProperty<string>(c => c.AccountType, "AccountType");
    /// <summary>
    /// Gets the AccountType value
    /// </summary>
    [Display(AutoGenerateField = false)]
