                                              ...
                                              var RowContentDiv = ContentDiv.Helpers.DivC("row");
                                              {
                                                  var LeftColContentDiv = RowContentDiv.Helpers.DivC("col-md-12 text-center");
                                                  {
                                                      var ProfileDiv = LeftColContentDiv.Helpers.With<MELib.Accounts.Account>(c => c.UserAccount);
                                                      {
                                                          ...
                                                          // Place Content Here
                                                          var Balance = ProfileDiv.Helpers.Span(c => "R " + c.Balance);
                                                          Balance.Style.FontSize = "15px";
                                                  ...
                                                  {
                                                      // Edit Profile
                                                      var EditProfileBtn = RightColContentDiv.Helpers.Button("Profile", Singular.Web.ButtonMainStyle.NoStyle, Singular.Web.ButtonSize.Large, Singular.Web.FontAwesomeIcon.userPlus);
                                                      {
                                                          EditProfileBtn.AddBinding(Singular.Web.KnockoutBindingString.click, "EditProfile()");
                                                          EditProfileBtn.AddClass("btn btn-warning btn-outline");
                                                      }
                                                      // Deposit Button
                                                      var DepositBtn = RightColContentDiv.Helpers.Button("Deposit", Singular.Web.ButtonMainStyle.NoStyle, Singular.Web.ButtonSize.Large, Singular.Web.FontAwesomeIcon.briefcase);
                                                      {
                                                          DepositBtn.AddBinding(Singular.Web.KnockoutBindingString.click, "DepositFunds()");
                                                          DepositBtn.AddClass("btn btn-success btn-outline");
                                                      }
                                                  }
                                              }
                                          }
