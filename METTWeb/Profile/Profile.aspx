                                  ...
                                  var RowContentDiv = ContainerTab.Helpers.DivC("row");
                                  {
                                      ...
                                      var LeftColRight = RowContentDiv.Helpers.DivC("col-md-9");
                                      {
                                          ...
                                          var AnotherCardDiv = LeftColRight.Helpers.DivC("ibox float-e-margins paddingBottom");
                                          {
                                              ...
                                              var ContentDiv = CardTitleToolsDiv.Helpers.DivC("ibox-content");
                                              {
                                                  var RowContentDivs = ContentDiv.Helpers.DivC("row");
                                                  {
                                                      var FormContent = RowContentDivs.Helpers.With<MELib.Accounts.Account>();
                                                       
                                                      {
                                                          FormContent.Helpers.BootstrapEditorRowFor(c => c.MovieTitle);
                                                      }  // Place holder
                                                  }
                                              }
                                          }
